...
export function getReport(id: string) { hydrate(); const report = reports.get(id); if (report) return report; if (!hasSupabaseConfig()) return createMockReportForId(id); return id === mockReport.id ? mockReport : undefined; }
