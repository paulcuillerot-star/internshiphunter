...
export const mockOffers: ScoredInternshipOffer[] = [
  offer("offer_1", "Sports Partnerships Intern", "World Triathlon", "Lausanne", "Switzerland", false, 91),
  offer("offer_2", "Event Operations and Marketing Intern", "FIBA", "Geneva", "Switzerland", false, 88),
...
export const mockReport: InternshipSearchReport = {
  ...
  status: "completed",
  isPaid: false,
  freeOffers: mockOffers.filter((item) => !item.isPremium),
